...
trait Exercise05 extends Homework {
  ...
  case class AppUnordered(func: Expr, args: List[Expr], assigned: Map[String, Expr]) extends Expr // | e(e,...,x=e)
  ...
  case class FunDef(params: List[String], default_vals : Map[String, Expr], body : Expr) extends Expr
